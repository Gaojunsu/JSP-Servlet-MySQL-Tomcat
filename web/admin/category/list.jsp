	...
	<HEAD>
		...
		<script type="text/javascript">
            ...
            function findAllCategory(){
                window.location.href = "${pageContext.request.contextPath}/AdminCategoryServlet?method=findAllCats";
            }
			...
			function deleteCategory(){
                ...
                xmlhttp.open("GET","${pageContext.request.contextPath}/AdminCategoryServlet?method=deleteCategory",true);
                xmlhttp.send();
            }
		</script>
	</HEAD>
				...
				<TBODY>
					...
					<tr>
						<td class="ta_01" align="left">
							<button type="button" id="serach" name="serach" value="查詢" class="button_surach" onclick="findAllCategory()">查詢</button>
