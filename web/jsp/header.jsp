	...
	var obj={"method":"findAllCats"};
		...
		$.post(url,obj,function (data) {
				...
				$.each(data,function (i,obj) {
                    ...
                    var  li="<li><a href='${pageContext.request.contextPath}/ProductServlet?method=findProductsByCidWithPage&cid="+obj.cid+"&num=1'>"+obj.cname+"</a></li>";
                    $("#myUL").append(li);
