...
<html>
	...
	<head>
		...
		<script src="${pageContext.request.contextPath}/js/jquery.min.1.12.4.js" type="text/javascript"></script>
		<script src="${pageContext.request.contextPath}/js/bootstrap.min.js" type="text/javascript"></script>

		<!-- Global site tag (gtag.js) - Google Analytics  谷歌分析工具-->
		<script async src="https://www.googletagmanager.com/gtag/js?id=UA-124356037-1"></script>
		<script>
            window.dataLayer = window.dataLayer || [];
            function gtag(){dataLayer.push(arguments);}
            gtag('js', new Date());
            gtag('config', 'UA-124356037-1');
		</script>
			...
			<div class="container-fluid">
				...
				<div class="col-md-10">
					<div class="col-md-6" style="text-align:center;height:200px;padding:0px;">
						<a href="${pageContext.request.contextPath}product_info.htm">
