...
<html>
	...
	<%@ include file="/jsp/header.jsp" %>
		...
		<div class="container">
			...
			<div>
				<hr/>
				<form id="orderForm" action="${pageContext.request.contextPath}/OrderServlet?method=payOrder&oid=${order.oid}" class="form-horizontal" style="margin-top:5px;margin-left:150px;" method="get">
